...
const experiences = [
  {
    ...
    company_name: "Epicmax",
    icon: tcsIon,
    iconBg: "#383E56",
    date: "Oct 2022 - Mar 2023",
    certificate: internshipone,
    points: [
      "Development according to the business requirements.",
      "Developing Front-end part of web application.",
      "Developing multi-language functionality.",
      "Team leading & code review.",
    ],
    skills: ["System Design", "React", "TypeScript", "SASS", "MUI", "MySql"],
  },
  {
    title: "Software Engineer",
    company_name: "Digipal",
    icon: tcsIon,
    date: "Sep 2019 - Sep 2022",
    certificate: internshiptwo,
    points: [
      "Developed and maintained PostgreSQL database of individual user's safety related data.",
      "Worked in a fast-paced, Agile development environment with teammates including product owners, business analysts to design and implement scalable solutions that meet up client's requirements.",
    ],
    skills: [
      "C#",
      ".NET",
  ...
  },
  {
    ...
    certificate: internshiptwo,
    points: [
      "Created new features for the back-office portal in .NET MVC with Entity Framework over Azure.",
      "Developed a tracking and reporting system utilizing .NET web services with Angular.",
      "Integrated with third-party ERP system for product management.",
    ],
    skills: ["C#", ".NET", "ASP.NET", "Angular", "React"],
  },
];
